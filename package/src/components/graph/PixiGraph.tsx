...
const InnerPixiGraph = memo(function (props: GraphContext) {
	...
	const [simulation, tick, requestTick] = useSimulation({
		nodes,
		links,
		graphConfig,
		container,
	...
	const updateNodeLabelProps = useCallback((idx: number, props: Rect) => {
		nodes[idx]!.labelProps = props;
		requestTick();
	}, [nodes])	
